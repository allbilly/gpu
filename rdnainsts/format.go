...
func initFormatTable() {
	...
	FormatTable[SMEM] = &Format{SMEM, "smem", 0xF4000000, 0xFC000000, 8, 18, 25}
	FormatTable[VOP3a] = &Format{VOP3a, "vop3a", 0xD4000000, 0xFC000000, 8, 16, 25} //
	FormatTable[VOP3b] = &Format{VOP3b, "vop3b", 0xD4000000, 0xFC000000, 8, 16, 25} //
	FormatTable[VINTRP] = &Format{VINTRP, "vintrp", 0xC8000000, 0xFC000000, 4, 16, 17}
	FormatTable[DS] = &Format{DS, "ds", 0xD8000000, 0xFC000000, 8, 18, 25} //
	...
	FormatTable[EXP] = &Format{EXP, "exp", 0xF8000000, 0xFC000000, 8, 0, 0}      //
