...
func (p *ScratchpadPreparerImpl) prepareSOP1(
	...
	copy(scratchPad[24:25], wf.ReadReg(rdnainsts.Regs[rdnainsts.SCC], 1, 0))
	copy(scratchPad[16:24], wf.ReadReg(rdnainsts.Regs[rdnainsts.EXEC], 1, 0))
}
...
func (p *ScratchpadPreparerImpl) prepareVOP1(
	...
	copy(sp[520:528], wf.ReadReg(rdnainsts.Regs[rdnainsts.VCC], 1, 0))
...
func (p *ScratchpadPreparerImpl) commitSOP1(
	...
	wf.WriteReg(rdnainsts.Regs[rdnainsts.EXEC], 1, 0, scratchpad[16:24])
	wf.WriteReg(rdnainsts.Regs[rdnainsts.SCC], 1, 0, scratchpad[24:25])
...
func (p *ScratchpadPreparerImpl) commitVOP1(
	...
	wf.WriteReg(rdnainsts.Regs[rdnainsts.VCC], 1, 0, scratchpad[520:528])
