...
var _ = Describe("Simple Register File", func() {
	...
	It("should write scalar registers", func() {
		...
		regWrite.Reg = rdnainsts.SReg(0)
		regWrite.LaneID = 0
		regWrite.WaveOffset = 0
		regWrite.Data = rdnainsts.Uint32ToBytes(15)

		registerFile.Write(regWrite)

		data := registerFile.storage[0:4]
		//Expect(regWrite.OK).To(BeTrue())
		Expect(rdnainsts.BytesToUint32(data)).To(Equal(uint32(15)))
	})

	It("should read scalar registers", func() {
		copy(registerFile.storage[104:108], rdnainsts.Uint32ToBytes(16))

		regRead := RegisterAccess{}
		regRead.Reg = rdnainsts.SReg(1)
		regRead.LaneID = 1
		...
		Expect(rdnainsts.BytesToUint32(regRead.Data)).To(Equal(uint32(16)))
	})
	...
	It("should write vector registers", func() {
		...
		regWrite := RegisterAccess{}
		regWrite.Reg = rdnainsts.VReg(10)
		regWrite.LaneID = 5
