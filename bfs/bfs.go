...
type Benchmark struct {
	...
	kernelTable *kernels.KernelTable
...
//go:embed codeobjects
var hsacoFS embed.FS

func (b *Benchmark) loadProgram() {
	b.kernelTable = kernels.NewKernelTable()
	b.kernelTable.Load(hsacoFS)
}
...
func (b *Benchmark) exec() {
	...
	isa := b.driver.GetGPUProperty(1).ISA
	kernel := b.kernelTable.Find("BFS_kernel_warp", isa)
	if kernel == nil {
