...
import (
	...
	"gitlab.com/akita/navisim/timing/caches/l1v"
	"gitlab.com/akita/navisim/timing/caches/rob"
	"gitlab.com/akita/navisim/timing/cp"
	"gitlab.com/akita/navisim/timing/cu"
...
func (b R9NanoGPUBuilder) Build(name string, id uint64) *navisim.GPU {
	b.createGPU(name, id)
	b.buildSAs()
	b.buildMemBanks()
	b.buildCP()
...
func (b *R9NanoGPUBuilder) createGPU(name string, id uint64) {
	...
	b.gpu = navisim.NewGPU(b.gpuName)
